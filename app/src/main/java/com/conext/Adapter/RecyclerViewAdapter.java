...
public class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerViewAdapter.RecyclerViewHolder> {
    ...
    public void onBindViewHolder(final RecyclerViewHolder holder, final int position) {
        pos = position;
        holder.imageViewbac.setImageBitmap(mValues.get(position).getDrawable());
        ...
        holder.imageViewbac.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!flag[0]) {
                    holder.imageViewbac.setImageBitmap(mValues.get(position).getDrawable());
                    if (mValues.get(position).getMentee() == 1)
                        holder.mentee.setVisibility(View.VISIBLE);
                    if (mValues.get(position).getMentor() == 1)
                        holder.mentor.setVisibility(View.VISIBLE);
