...
public class MyMentor {
    ...
    public void setMentorImage(Bitmap mentorImage) {
    ...
    public Bitmap getMentorImage() {
        return mentorImage;
    }

    public MyMentor(String mentorName, String mentorDescription, String mentorIn, String otherMentoring, Bitmap mentorImage) {
        this.mentorName = mentorName;
        this.mentorDescription = mentorDescription;
        this.mentorIn = mentorIn;
        this.otherMentoring = otherMentoring;
